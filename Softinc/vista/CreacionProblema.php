    ...
    <body>
       ...
       <form method="post" action="../controlador/Problema.php" enctype="multipart/form-data" id="formulario" onSubmit="return enviar();" >
            ...
            <tr><td><h4>Nombre del problema:</h4></tr></td>
             <tr><td><input type="text"    name="nombre" id="nombreProblema"  onBlur="existeProblema(this)" onFocus="foco(this)"   required>  </tr></td>          
             <tr><td><samp id="conprobarProblema"></samp><br/></td></tr> 
            <tr><td><h4>Inserte el enunciado:</h4></tr></td>                                   
            <tr><td><input type="file" name="enunciado" id="enunciado" required></td></tr>
