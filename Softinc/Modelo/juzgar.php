...
class Juzgar 
{
    ...
    function compilarPrograma($lenguaje, $CodigoFuente, $titulo,$tipoSolucion,$idCompetencia)     
    {
      ...
      //  echo "--$id_usuario--";
       ...
       if(!strcmp($lenguaje, "java") )
        ...
        {
                    $usuariosube="insert into solucion_olimpista(id_lenguaje, id_usuario ,id_problema, texto_solucion_olimpista, fecha_subida, hora_subida, calificacion_olimpista, mensage_calificacion, tiempo_ejecucion_olimpista,tipo_solucion,id_competencia_olimpista) values (3,$id_usuario ,$titulo,'$cambiarNombres','$fecha','$hora',0,'error compilar' ,0,'$tipoSolucion',$idCompetencia);";
                    pg_query($usuariosube);
                 //   echo "error compilar"; 
                  echo " <h1 align='center' class='Estilo1'  > Error compilar</h1> <br>";
                   echo " <h1 align='center' class='Estilo1' >Calificaion: 0 </h1>";
